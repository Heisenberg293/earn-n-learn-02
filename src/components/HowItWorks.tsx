...
const HowItWorks = () => {
  const steps = [
    ...
    },
    {
      ...
      description: "Browse available tasks or post your own project",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
    ...
    },
    {
      ...
      description: "Work on tasks and get paid upon completion",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600">
            Get started with earn-n-learn in three simple steps
          </p>
        </div>
